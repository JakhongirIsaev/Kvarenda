...
export function Home() {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      {/* Hero Section */}
      <section className="relative bg-primary/5 pt-24 pb-32 overflow-hidden">
        ...
        <div className="container relative z-10 mx-auto px-4">
          ...
          >
            ...
            <div className="bg-card p-4 rounded-2xl shadow-xl border border-border/50 flex flex-col md:flex-row gap-3">
